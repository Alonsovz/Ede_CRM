...
(function($){
   ...
   $.fn.justifiedGallery = function(options){
		...
		function startProcess(cont, images, settings){
			//FadeOut the loading image and FadeIn the files after their loading
		...
		function processesImages($, cont, images, lastRowWidth, settings){	
			...
			//last row----------------------
			//now we have all the files index loaded in the row arra
			...
			//fade in the files that we have changed and need to be reloaded
