    ...
    <div style="position: relative; margin-top:30px;  width: 700px">
        <table class="minimalistBlack" style="border: none">
            ...
            <tr>
                ...
                <td  style="width: 120px; border:none"><b style="font-size: 10px; font-weight: 400 ">Leonel Bolaños</b></td>
            </tr>
            <tr>
                <td  style="width: 75px; border:none"></td>
                <td  style="width: 120px; border:none"><b style="font-size: 10px; font-weight: 400 ">Ricardo Chevez</b></td>
            </tr>
            </tbody>
        </table>
    </div>
